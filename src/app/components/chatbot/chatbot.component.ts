...
export class ChatbotComponent implements OnInit {
 ...
 dayButton = [{ text: "Today" },{ text: "Yesterday" },{ text: "Earlier Than Yesterday" }];
  ...
  if (value) {
     ...
     var botDefaultresponse;
     botDefaultresponse= this.getCurrentTime().message  + ' '+  'I understand that you want to know about the check deposits. Do you still want to continue?';
       this.welcomebutton = [{ text: "Yes",postback: 'i want to know why my check has not been deposited yet' }, {text: "No", postback: "No"}];
       var messageBody1 = {
